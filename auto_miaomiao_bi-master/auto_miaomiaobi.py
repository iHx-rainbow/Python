...
def qu_guang_dian():
    ...
    for i in range(1, 41):
        ...
        time.sleep(1)
        os.system('adb shell input tap 950 1195')  # 点击去逛店，然后等15s
        print('进入店铺,浏览页面中，请等待15s...')
        time.sleep(12)

        screencap()
        img = Image.open('screen.png')
        print(img.getpixel((970, 1090)))
        if img.getpixel((970, 1090)) == (56, 33, 42, 255) or (255, 238, 187, 255) :
            os.system('adb shell input tap 970 1090')  # 点击得喵币
            print('已点击喵币，返回中...')
            time.sleep(1)
